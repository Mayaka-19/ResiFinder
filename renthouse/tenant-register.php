...
<body>
  ...
  <form method="POST" action="tenant-engine.php" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label for="full_name">Tenant ID:</label>
      <input type="text" class="form-control" id="tenant_id" placeholder="Enter ID number" name="tenant_id" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label for="id_type">Type of Document:</label>
    ...
    <hr>
    <center><button id="submit" name="tenant_register" class="btn btn" onclick="return Validate()">Register</button></center><br>
