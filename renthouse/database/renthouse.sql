...
INSERT INTO `add_property` (`property_id`, `country`, `county`, `town`, `contact_no`, `property_type`, `estimated_price`, `total_rooms`, `bedroom`, `living_room`, `kitchen`, `bathroom`, `description`, `owner_id`) VALUES
(123, 'Kenya', 'Kajiado', 'Ngong', 716531110, 'Full House Rent', 1000000, 12, 6, 1, 1, 4, 'An amazing six-bedroom mansion is up for rent in Ololua Ngong, located approximately 3 kilometers from Ngong town and about 700 meters from stage 46.', 40519624),
(124, 'Kenya', 'Nairobi', 'Karen',  723390834, 'Full House Rent', 3000000, 10, 4, 2, 1, 3, 'ResiFinder presents a newly built Townhouse in the heart of Karen.It enjoys serene neighborhood and has well manicured garden and matured trees.Sitting on half an acre.', 40519624);
...
(1, 'mayakajohnson00@gmail.com', '12345');
...
(40519624, 'Johnson Mayaka', 'mayakajohnson00@gmail.com', 'c33367701511b4f6020ec61ded352059', 0716531110, '337-Keroka', 'Citizenship', 'owner-photo/owner1.jpeg'); 
...
(174, 'product-photo/ngong1.jpeg', 123),
(175, 'product-photo/ngong2.jpeg', 123),
(176, 'product-photo/ngong3.jpeg', 123),
(177, 'product-photo/karen1.png', 124),
(178, 'product-photo/karen2.png', 124),
(179, 'product-photo/karen3.png', 124);
...
(40519624, 'Johnson Mayaka Ombeka', 'mayakajohnson00@gmail.com', '123456', 716531110, '337-Keroka', 'Citizenship', 'tenant-photo/owner1.jpeg');
...
--
INSERT INTO `chat` (`chat_id`, `message`, `owner_id`, `tenant_id`) VALUES
(1,'Hello! How can I help you?', 1, 2),
(2,'Hi there! What do you want to know about the property?', 1, 2);
...
--
ALTER TABLE `chat`
MODIFY `chat_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
