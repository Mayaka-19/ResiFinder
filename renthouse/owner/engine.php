...
function add_property(){
	...
	global $property_id,$country,$county,$town,$contact_no,$property_type,$estimated_price,$total_rooms,$bedroom,$living_room,$kitchen,$bathroom,$description,$latitude,$path,$p_photo,$property_photo_id,$longitude,$owner_id,$booked,$db;
	...
	$description=validate($_POST['description']);
        ...
        if(mysqli_num_rows($result1)>0)
      {
   	...
   	$sql = "INSERT INTO add_property(country,county,town,contact_no,property_type,estimated_price,total_rooms,bedroom,living_room,kitchen,bathroom,description,booked,owner_id) VALUES('$country','$county','$town','$contact_no','$property_type','$estimated_price','$total_rooms','$bedroom','$living_room','$kitchen','$bathroom','$description','$booked','$owner_id')";
