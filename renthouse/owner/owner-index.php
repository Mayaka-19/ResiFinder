...
<body>
 ...
 <div class="container-fluid">
  ...
  <p><button type="button" class="btn" data-toggle="modal" data-target="#myModal">Update Profile</button></p>
        ...
        <div class="col-sm-6">
          <div class="form-group">
              ...
              <select class="form-control" name="country" required="required">
                                ...
                                <option value="Nepal">Kenya</option>
              </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="town" required="required">
                                ...
                                <option value="Mosocho">Mosocho</option>
